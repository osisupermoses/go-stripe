...
// NewModels returns a model type with database conneection pool
...
func (m *DBModel) DeleteUser(id int) error {
	...
	// good approach here is to create a foriegn key relationship between user & token so it cascades
	// this, however, is a simple alternative
